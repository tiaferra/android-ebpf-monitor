...
\section{Linux}
Linux è una famiglia di sistemi operativi \textit{open-source} \textit{Unix-like}, basati sull'omonimo kernel, ampiamente utilizzato sia in ambito accademico sia industriale~\cite{linux_kernel} grazie alla sua stabilità, 
...
l’attivazione di un \textit{tracepoint}. Prima di essere caricati, i programmi eBPF vengono verificati da un componente del sistema operativo chiamato \textit{verifier}, che ne controlla la sicurezza 
...
Un programma \texttt{bpftrace} è costituito da una o più \textit{probe}, cioè punti di osservazione associati a eventi specifici. Ogni probe è composta da due parti principali:
