...
Dal 2014, con l’introduzione dell’extended Berkeley Packet Filter (eBPF) in Linux~\cite{ebpf_kernel}, è stata resa disponibile una tecnologia che 
...
\begin{figure}[h]         
    ...
    \caption{Architettura di eBPF nel kernel Linux}
...
il tracing delle applicazioni e del sistema operativo. bpftrace~\cite{bpftrace_docs} mette a disposizione un linguaggio di scripting ad alto livello che 
...
Tuttavia, l’utilizzo di bpftrace in ambiente Android presenta diverse difficoltà pratiche. In molti dispositivi l’accesso alle 
...
o non praticabile, soprattutto in ambienti di produzione, dove tipicamente non sono disponibili 
i permessi di root necessari all'installazione e all'utilizzo di tali strumenti. Ottenere tali 
...
All’interno dell’ambiente Android è stata installata una distribuzione Linux minimale basata su Debian. Questa distribuzione è 
...
\begin{figure}[h]
      \centering
      \includegraphics[width=0.3\textwidth]{images/architettura-soluzione.png}
