...
Il monitoraggio delle attività delle applicazioni è fondamentale in diversi ambiti, tra cui il \textit{debugging} del software,
...
Tradizionalmente il \textit{tracing} del sistema operativo viene realizzato mediante strumenti specifici che permettono di raccogliere 
...
\textit{overhead} computazionale oppure richiedere modifiche al sistema operativo, rendendone difficile l’utilizzo in ambienti reali. 
...
il tracing delle applicazioni e del sistema operativo.\texttt{ bpftrace}~\cite{bpftrace_docs} mette a disposizione un linguaggio di \textit{scripting} ad alto livello che 
...
permessi richiederebbe di effettuare il \textit{rooting} del dispositivo o di sostituire la \textit{release}
...
nonostante il loro potenziale per il \textit{monitoring} del sistema. Risulta quindi necessario definire un ambiente di lavoro che consenta l’utilizzo 
