...
\subsection{Il modulo di orchestrazione: monitor.py}
...
\subsection{Il modulo di analisi: summary.py}
...
\subsection{L'interfaccia utente: launcher.sh}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{images/process-lifecycle.png}
    \caption{Diagramma del ciclo di vita di un processo Linux: fork, exec e exit con i relativi tracepoint osservati.}
...
\subsection{binder.bt — Monitoraggio IPC Binder}
...
\subsection{Probe di rete: net\_send, net\_recv, net\_bind, net\_accept}
...
% -------------------------------------------------------
\section{L'orchestratore: monitor.py}
...
\begin{figure}[h]
    ...
    \caption{Pipeline di elaborazione degli eventi in monitor.py: normalizzazione, arricchimento e validazione.}
...
% -------------------------------------------------------
\section{Il launcher interattivo: launcher.sh}
...
% -------------------------------------------------------
\section{Il modulo di analisi: summary.py}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{images/report-rete.png}
    \caption{Esempio di output del report di analisi di rete con timeline del traffico e port landscape.}
    \label{fig:report-rete}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{images/albero-processi.png}
    \caption{Esempio di albero dei processi ricostruito da summary.py a partire dai campi pid e ppid degli eventi.}
    \label{fig:albero-processi}
\end{figure}
