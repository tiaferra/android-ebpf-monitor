...
Il sistema è composto da quattro componenti principali che collaborano secondo un'architettura a pipeline: il livello di raccolta basato su probe bpftrace raccoglie eventi direttamente dal kernel, il modulo di orchestrazione li normalizza e persiste, il modulo di analisi li elabora in fase post-sessione, e l'interfaccia utente orchestra l'intera interazione. L'architettura complessiva è illustrata in Figura~\ref{fig:architettura-sistema}.
